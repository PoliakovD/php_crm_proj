            ...
            <form action="{{ route('applications.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description"
                              ...
                              rows="4"
                              placeholder="Подробности заявки...">{{ old('description') }}</textarea>
                    @error('description')
                    <div class="form-error"><i class="fas fa-exclamation-circle"></i>{{ $message }}</div>
                    @enderror
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="status" name="status" class="form-select @error('status') is-invalid @enderror" required>
                            @foreach($statuses as $value => $label)
                                <option value="{{ $value }}" {{ old('status', \App\Enums\ApplicationStatusEnum::NEW->value) == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="form-error"><i class="fas fa-exclamation-circle"></i>{{ $message }}</div>
                    @enderror
                    <div class="form-text">Оставьте пустым, чтобы создать анонимную заявку</div>
                </div>
